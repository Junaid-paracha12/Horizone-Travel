  ...
  const routesAPI = [
    {
      ...
      icon: "/heart.png",
      title: "Paris to Nice",
      address: "Parisian Charm Express",
      type: "Luxury",
    ...
    },
    {
      img: "/cou2.jpg",
      icon: "/heart.png",
      title: "Bordeaux to Strasbourg",
      address: "Vineyard Voyage",
      type: "Economy",
      adsicon: "/trainicon.png",
      typeicon: "/circle.png",
      prize: "$180",
    ...
    },
    {
      img: "/cou3.jpg",
      icon: "/heart.png",
      title: "Marseille to Avignon",
      address: "Provencal Sunshine Sprint",
      type: "Economy",
      adsicon: "/trainicon.png",
      typeicon: "/circle.png",
      prize: "$180",
    ...
    },
    {
      img: "/cou4.jpg",
      icon: "/heart.png",
      title: "Lyon to Chamonix",
      address: "Majestic Alps Explorer",
      type: "Luxury",
      adsicon: "/trainicon.png",
      typeicon: "/circle.png",
      prize: "$180",
      ...
      <div className="px-2">
        <div className="flex flex-col gap-2 text-center sm:text-start">
          ...
          <p className="text-slate-700 text-sm md:text-base">
            Discover the most trending hotels worldwide for an unforgetable experience.
          </p>
